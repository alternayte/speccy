  ...
  return (
    <D.Root open={open} onOpenChange={onOpenChange}>
      <D.Portal>
        ...
        <D.Content className="fixed top-[12vh] left-1/2 z-50 w-[calc(100vw-2rem)] max-w-[480px] -translate-x-1/2 rounded-lg border border-line bg-surface p-5 shadow-pop focus:outline-none">
