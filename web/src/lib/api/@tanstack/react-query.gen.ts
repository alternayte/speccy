 ...
 *
 */
export const withdrawAcknowledgementMutation = (options?: Partial<Options<WithdrawAcknowledgementData>>): UseMutationOptions<WithdrawAcknowledgementResponse, WithdrawAcknowledgementError, Options<WithdrawAcknowledgementData>> => {
    const mutationOptions: UseMutationOptions<WithdrawAcknowledgementResponse, WithdrawAcknowledgementError, Options<WithdrawAcknowledgementData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await withdrawAcknowledgement({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
