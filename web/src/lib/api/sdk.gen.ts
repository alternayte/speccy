 ...
 */
export const takeHandoffZip = <ThrowOnError extends boolean = false>(options: Options<TakeHandoffZipData, ThrowOnError>): RequestResult<TakeHandoffZipResponses, TakeHandoffZipErrors, ThrowOnError> => (options.client ?? client).post<TakeHandoffZipResponses, TakeHandoffZipErrors, ThrowOnError>({
 ...
 */
export const deleteBundlePlan = <ThrowOnError extends boolean = false>(options: Options<DeleteBundlePlanData, ThrowOnError>): RequestResult<DeleteBundlePlanResponses, DeleteBundlePlanErrors, ThrowOnError> => (options.client ?? client).get<DeleteBundlePlanResponses, DeleteBundlePlanErrors, ThrowOnError>({ url: '/bundles/{bundleId}/delete-plan', ...options });
 ...
 */
export const verificationEvents = <ThrowOnError extends boolean = false>(options: Options<VerificationEventsData, ThrowOnError, VerificationEventsResponse>): Promise<ServerSentEventsResult<VerificationEventsResponses>> => (options.client ?? client).sse.get<VerificationEventsResponses, VerificationEventsErrors, ThrowOnError>({ url: '/verifications/{runId}/events', ...options });

/**
 * One verification run with the outcome of each trace ID.
 */
export const getVerification = <ThrowOnError extends boolean = false>(options: Options<GetVerificationData, ThrowOnError>): RequestResult<GetVerificationResponses, GetVerificationErrors, ThrowOnError> => (options.client ?? client).get<GetVerificationResponses, GetVerificationErrors, ThrowOnError>({ url: '/verifications/{runId}', ...options });
 ...
 *
 */
export const removeLink = <ThrowOnError extends boolean = false>(options: Options<RemoveLinkData, ThrowOnError>): RequestResult<RemoveLinkResponses, RemoveLinkErrors, ThrowOnError> => (options.client ?? client).delete<RemoveLinkResponses, RemoveLinkErrors, ThrowOnError>({ url: '/docs/{docId}/links', ...options });
 ...
 */
export const coverTraceId = <ThrowOnError extends boolean = false>(options: Options<CoverTraceIdData, ThrowOnError>): RequestResult<CoverTraceIdResponses, CoverTraceIdErrors, ThrowOnError> => (options.client ?? client).post<CoverTraceIdResponses, CoverTraceIdErrors, ThrowOnError>({
 ...
 *
 */
export const suggestLinks = <ThrowOnError extends boolean = false>(options: Options<SuggestLinksData, ThrowOnError>): RequestResult<SuggestLinksResponses, SuggestLinksErrors, ThrowOnError> => (options.client ?? client).post<SuggestLinksResponses, SuggestLinksErrors, ThrowOnError>({
    url: '/links/suggest',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 *
 */
export const withdrawAcknowledgement = <ThrowOnError extends boolean = false>(options: Options<WithdrawAcknowledgementData, ThrowOnError>): RequestResult<WithdrawAcknowledgementResponses, WithdrawAcknowledgementErrors, ThrowOnError> => (options.client ?? client).post<WithdrawAcknowledgementResponses, WithdrawAcknowledgementErrors, ThrowOnError>({
 ...
 */
export const markInboxItemRead = <ThrowOnError extends boolean = false>(options: Options<MarkInboxItemReadData, ThrowOnError>): RequestResult<MarkInboxItemReadResponses, MarkInboxItemReadErrors, ThrowOnError> => (options.client ?? client).post<MarkInboxItemReadResponses, MarkInboxItemReadErrors, ThrowOnError>({
    url: '/inbox/read',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const deleteProfile = <ThrowOnError extends boolean = false>(options: Options<DeleteProfileData, ThrowOnError>): RequestResult<DeleteProfileResponses, DeleteProfileErrors, ThrowOnError> => (options.client ?? client).delete<DeleteProfileResponses, DeleteProfileErrors, ThrowOnError>({ url: '/profiles/{key}', ...options });
 ...
 */
export const diffProfileVersions = <ThrowOnError extends boolean = false>(options: Options<DiffProfileVersionsData, ThrowOnError>): RequestResult<DiffProfileVersionsResponses, DiffProfileVersionsErrors, ThrowOnError> => (options.client ?? client).get<DiffProfileVersionsResponses, DiffProfileVersionsErrors, ThrowOnError>({ url: '/profiles/{key}/diff', ...options });

/**
 * Write a new version whose text equals an earlier one. No number changes meaning.
 */
export const rollbackProfile = <ThrowOnError extends boolean = false>(options: Options<RollbackProfileData, ThrowOnError>): RequestResult<RollbackProfileResponses, RollbackProfileErrors, ThrowOnError> => (options.client ?? client).post<RollbackProfileResponses, RollbackProfileErrors, ThrowOnError>({
 ...
 */
export const resolveGithubUrl = <ThrowOnError extends boolean = false>(options: Options<ResolveGithubUrlData, ThrowOnError>): RequestResult<ResolveGithubUrlResponses, ResolveGithubUrlErrors, ThrowOnError> => (options.client ?? client).post<ResolveGithubUrlResponses, ResolveGithubUrlErrors, ThrowOnError>({
    url: '/github/resolve',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const undismissDoc = <ThrowOnError extends boolean = false>(options: Options<UndismissDocData, ThrowOnError>): RequestResult<UndismissDocResponses, UndismissDocErrors, ThrowOnError> => (options.client ?? client).delete<UndismissDocResponses, UndismissDocErrors, ThrowOnError>({ url: '/dismissed-docs', ...options });

/**
 * The markdown files a person marked as not a spec (REQ-133).
 */
export const listDismissedDocs = <ThrowOnError extends boolean = false>(options?: Options<ListDismissedDocsData, ThrowOnError>): RequestResult<ListDismissedDocsResponses, ListDismissedDocsErrors, ThrowOnError> => (options?.client ?? client).get<ListDismissedDocsResponses, ListDismissedDocsErrors, ThrowOnError>({ url: '/dismissed-docs', ...options });

/**
 * Mark a markdown file as not a spec, so Speccy stops offering to adopt it (REQ-133).
 */
export const dismissDoc = <ThrowOnError extends boolean = false>(options: Options<DismissDocData, ThrowOnError>): RequestResult<DismissDocResponses, DismissDocErrors, ThrowOnError> => (options.client ?? client).post<DismissDocResponses, DismissDocErrors, ThrowOnError>({
    url: '/dismissed-docs',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const listSkippedDocs = <ThrowOnError extends boolean = false>(options: Options<ListSkippedDocsData, ThrowOnError>): RequestResult<ListSkippedDocsResponses, ListSkippedDocsErrors, ThrowOnError> => (options.client ?? client).get<ListSkippedDocsResponses, ListSkippedDocsErrors, ThrowOnError>({ url: '/github/sources/{sourceId}/skipped', ...options });

/**
 * Accept a doc type for skipped docs of the source, held in Speccy (REQ-133). The repo takes no commit.
 */
export const adoptSkippedDocs = <ThrowOnError extends boolean = false>(options: Options<AdoptSkippedDocsData, ThrowOnError>): RequestResult<AdoptSkippedDocsResponses, AdoptSkippedDocsErrors, ThrowOnError> => (options.client ?? client).post<AdoptSkippedDocsResponses, AdoptSkippedDocsErrors, ThrowOnError>({
 ...
 */
export const publishSourceMapping = <ThrowOnError extends boolean = false>(options: Options<PublishSourceMappingData, ThrowOnError>): RequestResult<PublishSourceMappingResponses, PublishSourceMappingErrors, ThrowOnError> => (options.client ?? client).post<PublishSourceMappingResponses, PublishSourceMappingErrors, ThrowOnError>({ url: '/github/sources/{sourceId}/mapping', ...options });
