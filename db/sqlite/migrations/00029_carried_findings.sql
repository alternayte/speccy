...
ALTER TABLE verdict ADD COLUMN items JSONTEXT NOT NULL DEFAULT '[]';
ALTER TABLE verdict ADD COLUMN carried_run_id UUIDTEXT;
ALTER TABLE verdict ADD COLUMN carried_findings JSONTEXT NOT NULL DEFAULT '[]';
ALTER TABLE verdict ADD COLUMN sections_changed INTEGER NOT NULL DEFAULT 0;
