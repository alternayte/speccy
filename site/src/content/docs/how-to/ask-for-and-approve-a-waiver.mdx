...
- The next action in the control row reads "Decide the waiver of" and the check. For an acknowledgement it reads "Decide the acknowledgement of" and the trace ID, or "Decide the standalone acknowledgement".
