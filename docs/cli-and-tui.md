...
| `speccy init --github` | Adopts this repo: one mapping for each doc it recognises, the checks that fail today in adoption mode, and `.github/workflows/speccy.yml`. |
